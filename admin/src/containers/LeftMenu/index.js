...
import { default as LinkMenuHeaderTitle } from "../../components/LeftMenu/LeftMenuLinkHeader/Title";
import { default as LeftMenuListLink } from "../../components/LeftMenu/LeftMenuLinkSection/LeftMenuListLink";
import { default as LeftMenuLink } from "../../components/LeftMenu/LeftMenuLink";
  ...
  return (
    <Wrapper>
      ...
      <LinksContainer>
        ...
        <LinkMenuHeaderTitle>外部連結</LinkMenuHeaderTitle>
        <LeftMenuListLink>
          <LeftMenuLink
            destination="https://hkirs-tvp-web.silwolf.io/"
            label="HKIRS 師生平台"
            location={location}
            notificationCount={0}
          />
